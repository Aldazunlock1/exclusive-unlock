...
<div class="container">
    ...
    <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '>'">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{route('frontend_imei_service')}}" class="breadcrumb-item active">IMEI</a></li>
                    ...
                    <div class="text-bg-light ps-4 pt-4 pe-4 pb-4 border rounded" style="height: min-content">
                            ...
                            <table class="table mb-4">
                                <tbody  @if (count($serviceInputs) != 0)class="border-bottom" @endif>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 pt-0 text-end pe-0"><b>{{$currencyIcon}}{{$Price}}</b></td>
                                    </tr>
                                    @endif
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="fields.{{ $index }}" placeholder="{{$serviceInput->name}}">
                            </div>
                            @endforeach
                        </div>
                        @endif
                        ...
                        <div class="mb-1">
                            <button class="btn btn-primary rounded w-100 place-order"><i class="fas fa-cart-plus"></i> Place an Order</button>
