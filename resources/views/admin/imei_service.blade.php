        ...
        <div class="card table-card">
            <div class="card-header service-card-header" style="padding: 12px 15px">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h5 class="mb-3 mb-sm-0">IMEI Service</h5>
            ...
            <div class="customer-m-menu-content" id="content" >
                <div id="general" class="section">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="service_article" cols="30" rows="22" placeholder="Article"></textarea>
                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="new-service-form">
                <div class="modal-header">
                    <h5 class="modal-title" id="addNewServiceLabel">Add new imei service</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    $(document).ready(function() {
        ...
        var table = $('#data-table').DataTable({
            ...
            drawCallback: function(settings) {
                ...
                $('.card-header h5').text('IMEI Service - ' + totalEntries);
                $('#imei-count').text(totalEntries);
        ...
        $(document).on('click', '#update-service', function() {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    // Display the error
                    alert(`Error occurred while updating: ${errorMessage}`);
                }
            });
        });
        // END - UPDATE SERVICE
