        ...
        <div class="card table-card">
            <div class="card-header service-card-header" style="padding: 12px 15px">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h5 class="mb-3 mb-sm-0">Credit Service</h5>
            ...
            <div class="card-header selected-card-header" style="padding: 11px 15px; display:none;background:#dfe8f6; border-top-left-radius:10px; border-top-right-radius:10px">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h5 class="mb-3 mb-sm-0" id="selectedcount"></h5>
                    <div class="d-flex gap-2">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#data-table').DataTable({
            ...
            footer: false,
            ajax: {
                url: '{{ route('fetch_credit_service') }}',
                type: 'GET',
                beforeSend: function() {
                    $('.top-loader').show();
            ...
            drawCallback: function(settings) {
                ...
                $('.card-header h5').text('Credit Service - ' + totalEntries);
        ...
        $('#base_price, #customer_profit, #reseller_profit, #distributor_profit, #webowner_profit, #service_max_qnt, #service_min_qnt, #new-service-min-qnt, #new-service-max-qnt').on('input', function() {
