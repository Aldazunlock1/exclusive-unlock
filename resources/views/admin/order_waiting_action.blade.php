        ...
        <div class="card table-card">
            <div class="card-header service-card-header" style="padding: 12px 15px">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h5 class="mb-3 mb-sm-0">Waiting Action</h5>
                    <div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#data-table').DataTable({
            ...
            footer: false,
            ajax: {
                url: '{{ route('table_order_waiting_action') }}',
                type: 'GET',
                beforeSend: function() {
                    $('.top-loader').show();
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    searchable: true,
                    render: function(data) {
                        return `<span class="badge bg-light-primary fs-6" style="float:right">${'<i class="fas fa-hourglass-half"></i> ' + data}</span>`;
                    }
                }
            ],
            order: [[0, 'desc']],
            ...
            drawCallback: function(settings) {
                ...
                $('.card-header h5').text('Waiting Action - ' + totalEntries);
                $('#waitingActionCount').text(totalEntries);
                ...
                success: function(response) {
                    ...
                    let detailsHtml = `
                        ...
                        <div class="offcanvas-body">
                            ...
                            <div class="offcanvas-order-details-list"><span class="offcanvas-order-details-list-1">Status</span> <span class="offcanvas-order-details-list-2"><span class="badge bg-light-primary fs-6">${'<i class="fas fa-hourglass-half"></i> ' + response.order.service_status}</span></span></div>
                        </div>
        ...
        $(document).on('click', '#successButton', function() {
            ...
            $.ajax({
                url: '/admin/replay-accept/' + orderId,
                method: 'POST',
                contentType: 'application/json',
                data: JSON.stringify({
                    status: 'In Process',
