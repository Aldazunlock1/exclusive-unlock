...
<html lang="en">
  <head>
    ...
    <title>{{$site_title}} - Login OTP</title>
        ...
        >
          <div style="width: 100%; max-width: 489px; margin: 0 auto;">
            ...
            <p
              ...
              "
            >
            Use the following OTP to log in to your account. The OTP will expire in 10 minutes. If the OTP expires, please submit a new login request.
            </p>
