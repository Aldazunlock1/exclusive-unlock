...
<html lang="en">
  <head>
    ...
    <title>{{$site_title}} - Password Reset</title>
        ...
        >
          <div style="width: 100%; max-width: 489px; margin: 0 auto;">
            ...
            <p
              ...
              "
            >
            Use the following OTP to reset password for your account. The OTP will expire in 5 minutes. If the OTP expires, please submit a new password reset request.
            </p>
