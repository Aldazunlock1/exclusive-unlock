...
<head>
    ...
    <title>You Have Placed an Order Successfully</title>
...
<body>
    <div class="container">
        <h1>Dear {{$mailData->customer_name}}, You Have Placed an Order Successfully ✅</h1>
        <p>
            <div style="border-bottom: 1px solid #e3e3e3; padding-bottom:10px; margin-bottom:10px; border-top: 1px solid #e3e3e3; padding-top:10px; margin-top:10px">{{$mailData->service_title}}</div>
            <div style="border-bottom: 1px solid #e3e3e3; padding-bottom:10px; margin-bottom:10px">Order ID: <span style="float: right">#{{$mailData->order_id}}</span></div>
            ...
            <div>Order Placed by: <span style="float: right">{{$mailData->order_placed}}</span></div>
        </p>
    </div>
